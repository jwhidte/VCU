...
echo ### Beginning Build for Training_003 ...
...
copy .\_buildgen\Output\absolute.elf Training.elf
C:\\HighTec\\TriCore\bin\tricore-nm.exe -a Training.elf > Training.sym
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\ECU\RPG\Training\Training_raptor_rtw\Training_003.hex" /Y

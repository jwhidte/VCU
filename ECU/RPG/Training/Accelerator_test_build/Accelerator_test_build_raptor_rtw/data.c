...
const RAMVariables_T RAMVariables_DEFAULT = {
  ...
  { 0, 0, },                           /* raptorFaultCounts_X */

  { 0, 0, },                           /* raptorFaultCounts_Y */
  0U,                                  /* EEPROM_State */
};
...
const CONSTVariables_T CONSTVariables = {
  ...
  { 65U, 99U, 99U, 101U, 108U, 101U, 114U, 97U, 116U, 111U, 114U, 95U, 116U,
    101U, 115U, 116U, 95U, 98U, 117U, 105U, 108U, 100U, },/* ModelName */
  21UL,                                /* BuildNumber */
  ...
  { 65U, 99U, 99U, 101U, 108U, 101U, 114U, 97U, 116U, 111U, 114U, 95U, 116U,
    101U, 115U, 116U, 95U, 98U, 117U, 105U, 108U, 100U, 95U, 48U, 50U, 49U, },/* SwIdTxt */

  { 65U, 99U, 99U, 101U, 108U, 101U, 114U, 97U, 116U, 111U, 114U, 95U, 116U,
    101U, 115U, 116U, 95U, 98U, 117U, 105U, 108U, 100U, 95U, 48U, 50U, 49U, 95U,
    48U, 48U, 48U, },                  /* CalIdTxt */

  { 51U, 79U, 107U, 116U, 72U, 68U, 81U, 85U, 107U, 107U, 109U, 120U, 71U, 95U,
    110U, 71U, 80U, 116U, 112U, 95U, 48U, },/* BuildUID */
  3,                                   /* IdTableRev */
  2954298118UL,                        /* HardwareType */

  { 49U, 57U, 45U, 65U, 112U, 114U, 45U, 50U, 48U, 50U, 52U, 32U, 49U, 53U, 58U,
    52U, 48U, 58U, 50U, 50U, },        /* DateStamp */
};
...
/* Total EEPROM Structure Size: 322U Bytes */
#define START_SECTION_Const_oem_32bit
#include "swsh_rb2oem.h"

const EEVariables_T EEVariables_DEFAULT = {
  0,                                  /* Write Count: Identifies active Copy 	*/
  656860320U,                          /* EE_UniqID 	*/

  { 0U, 0U, },                         /* raptorFaultNonVolatileBits */
  0.2F,                                /* KeySwHiTimeThr */
  0.2F,                                /* KeySwLoTimeThr */
  ...
  { FLTOP_NOTHING, FLTOP_NOTHING, },   /* raptorFaultOperation */
...
const RAMEditVariables_T RAMEditVariables_DEFAULT = {
  ...
  0.0F,                                /* Inverter_enb_override_OvrVal */
  ...
  0.0F,                                /* POT1_OvrVal */
  0U,                                  /* POT1_OvrSts */
  0.0F,                                /* TP_override_OvrVal */
  0U,                                  /* TP_override_OvrSts */

...
echo ### Beginning Build for Accelerator_test_build_021 ...
...
copy .\_buildgen\Output\absolute.elf Accelerator_test_build.elf
C:\\HighTec\\TriCore\bin\tricore-nm.exe -a Accelerator_test_build.elf > Accelerator_test_build.sym
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\ECU\RPG\Training\Accelerator_test_build\Accelerator_test_build_raptor_rtw\Accelerator_test_build_021.hex" /Y

...
void rxFn_1619__0001(void * data);

#define START_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxBuf_1619__0001[1U][8];
uint8_T rxLen_1619__0001[1U];
uint16_T rxAge_1619__0001;
uint32_T rxID_1619__0001[1U];

#define STOP_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxQHead_1619__0001 = 0;
uint8_T rxQTail_1619__0001 = 0;
...
/* <S26>/raptor_can_txmsg */
uint32_T can_set_period_1917__0001(uint32_T);

/* <S6>/raptor_can_txmsg */
uint32_T can_set_period_1396__0001(uint32_T);
...
void pre_start_CAN_CAN1(void)
{
  ...
  {
    memset((void *)&rxBuf_1619__0001[0][0], 0, sizeof(rxBuf_1619__0001));
    memset((void *)&rxLen_1619__0001[0], 0, sizeof(rxLen_1619__0001));
    rxAge_1619__0001 = MAX_AGE;
  }
...
void rxFn_1619__0001(void * data)
{
  ...
  if ((msg->parameter1 == 8U) ) {
    for (i = 0; i < 8; i++) {
      if (i < msg->parameter1)
        rxBuf_1619__0001[rxQHead_1619__0001][i] = b[i];
      else
        rxBuf_1619__0001[rxQHead_1619__0001][i] = 0;
    }

    rxLen_1619__0001[rxQHead_1619__0001] = msg->parameter1;
    rxID_1619__0001[rxQHead_1619__0001] = msg->message_id;
    if ((rxQHead_1619__0001 == rxQTail_1619__0001) && (rxAge_1619__0001 == 0))
      rxQTail_1619__0001 = (rxQTail_1619__0001 + 1) % 1U;
    if ((rxQHead_1619__0001 == (rxQTail_1619__0001 + 1)% 1U) &&
        (rxAge_1619__0001 != 0))
      rxQTail_1619__0001 = (rxQTail_1619__0001 + 1) % 1U;
    rxQHead_1619__0001 = (rxQHead_1619__0001 + 1 ) % 1U;
    rxAge_1619__0001 = 0;
  }
}

uint8_T can_get_1619__0001(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_1619__0001;
  if (id != NULL)
    *id = rxID_1619__0001[rxQTail_1619__0001];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (length > rxLen_1619__0001[rxQTail_1619__0001])
      length = rxLen_1619__0001[rxQTail_1619__0001];
    for (i = 0; i < 8; i++)
      data[i] = rxBuf_1619__0001[rxQTail_1619__0001][i];
  }

  if ((rxQHead_1619__0001 != (rxQTail_1619__0001 + 1)% 1U) && (rxAge_1619__0001 ==
       0))
    rxQTail_1619__0001 = (rxQTail_1619__0001 + 1) % 1U;
  else if (rxAge_1619__0001 < MAX_AGE)
    rxAge_1619__0001++;
  return length;
}
...
/**** txMsgNum: 0 										 ****/
/**** i: 0 										 				 ****/
void can_send_1917__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
...
uint32_T can_set_period_1917__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
/**** txMsgNum: 1 										 ****/
/**** i: 1 										 				 ****/
void can_send_1396__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!can_CAN1_startupDelay) {
    can_update_CAN1(id, extended, (length > 8U) ? 8U : length, data);
...
uint32_T can_set_period_1396__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;

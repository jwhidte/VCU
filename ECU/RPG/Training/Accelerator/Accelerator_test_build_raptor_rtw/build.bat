...
echo ### Beginning Build for Accelerator_test_build_004 ...
...
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\ECU\RPG\Training\Accelerator\Accelerator_test_build_raptor_rtw\Accelerator_test_build_004.hex" /Y

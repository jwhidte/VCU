...
extern uint8_T can_get_68__0002(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length);
extern void can_update_CAN2(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data);

/* Transmit CAN object declarations */
extern void can_send_97__0002(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern void can_send_31__0002(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);

...
void rxFn_68__0002(void * data);

#define START_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxBuf_68__0002[1U][8];
uint8_T rxLen_68__0002[1U];
uint16_T rxAge_68__0002;
uint32_T rxID_68__0002[1U];

#define STOP_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxQHead_68__0002 = 0;
uint8_T rxQTail_68__0002 = 0;

/* Transmit CAN Object Declarations */
/* <S2>/raptor_can_txmsg */
uint32_T can_set_period_97__0002(uint32_T);

/* <S6>/raptor_can_txmsg */
uint32_T can_set_period_31__0002(uint32_T);
...
{
  {
    memset((void *)&rxBuf_68__0002[0][0], 0, sizeof(rxBuf_68__0002));
    memset((void *)&rxLen_68__0002[0], 0, sizeof(rxLen_68__0002));
    rxAge_68__0002 = MAX_AGE;
  }
...
void rxFn_68__0002(void * data)
{
  ...
  if ((msg->parameter1 == 8U) ) {
    for (i = 0; i < 8; i++) {
      if (i < msg->parameter1)
        rxBuf_68__0002[rxQHead_68__0002][i] = b[i];
      else
        rxBuf_68__0002[rxQHead_68__0002][i] = 0;
    }

    rxLen_68__0002[rxQHead_68__0002] = msg->parameter1;
    rxID_68__0002[rxQHead_68__0002] = msg->message_id;
    if ((rxQHead_68__0002 == rxQTail_68__0002) && (rxAge_68__0002 == 0))
      rxQTail_68__0002 = (rxQTail_68__0002 + 1) % 1U;
    if ((rxQHead_68__0002 == (rxQTail_68__0002 + 1)% 1U) && (rxAge_68__0002 != 0))
      rxQTail_68__0002 = (rxQTail_68__0002 + 1) % 1U;
    rxQHead_68__0002 = (rxQHead_68__0002 + 1 ) % 1U;
    rxAge_68__0002 = 0;
  }
}

uint8_T can_get_68__0002(uint16_T *age, uint32_T* id, uint8_T* extended, uint8_T
  *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_68__0002;
  if (id != NULL)
    *id = rxID_68__0002[rxQTail_68__0002];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (length > rxLen_68__0002[rxQTail_68__0002])
      length = rxLen_68__0002[rxQTail_68__0002];
    for (i = 0; i < 8; i++)
      data[i] = rxBuf_68__0002[rxQTail_68__0002][i];
  }

  if ((rxQHead_68__0002 != (rxQTail_68__0002 + 1)% 1U) && (rxAge_68__0002 == 0))
    rxQTail_68__0002 = (rxQTail_68__0002 + 1) % 1U;
  else if (rxAge_68__0002 < MAX_AGE)
    rxAge_68__0002++;
  return length;
}
...
/**** txMsgNum: 1 										 ****/
/**** i: 1 										 				 ****/
void can_send_97__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
...
uint32_T can_set_period_97__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
/**** txMsgNum: 2 										 ****/
/**** i: 2 										 				 ****/
void can_send_31__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!can_CAN2_startupDelay) {
    can_update_CAN2(id, extended, (length > 8U) ? 8U : length, data);
...
uint32_T can_set_period_31__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;

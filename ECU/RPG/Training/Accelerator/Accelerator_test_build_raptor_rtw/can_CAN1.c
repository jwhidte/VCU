...
/* <S14>/raptor_can_txmsg */
uint32_T can_set_period_94__0002(uint32_T);
...
/**** txMsgNum: 0 										 ****/
/**** i: 0 										 				 ****/
void can_send_94__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
...
uint32_T can_set_period_94__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;

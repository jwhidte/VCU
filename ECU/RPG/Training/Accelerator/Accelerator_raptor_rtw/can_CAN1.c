...
void rxFn_286__0002(void * data);

#define START_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxBuf_286__0002[1U][8];
uint8_T rxLen_286__0002[1U];
uint16_T rxAge_286__0002;
uint32_T rxID_286__0002[1U];

#define STOP_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxQHead_286__0002 = 0;
uint8_T rxQTail_286__0002 = 0;

/* Block: <S4>/raptor_xcp_update */
...
uint32_T can_set_period_744__0001(uint32_T);

/* <S2>/raptor_can_txmsg */
uint32_T can_set_period_747__0001(uint32_T);

/* <S6>/raptor_can_txmsg */
uint16_T txPeriod_38__0002 = 10U;
uint32_T txLastTx_38__0002 = 10U;
uint32_T can_set_period_38__0002(uint32_T);

/* <S4>/raptor_xcp_update */
...
void pre_start_CAN_CAN1(void)
{
  if (RxTrig_XCP_BC_CAN1_msgID != 0x7e0 && RxTrig_XCP_BC_CAN1_msgID != 0x7e8) {
    canMsgInfo[RX_MSG_ENTRY_START + 1].MessageId = RxTrig_XCP_BC_CAN1_msgID;
  }

  if (RxTrig_XCP_CMD_CAN1_msgID != 0x7e0 && RxTrig_XCP_CMD_CAN1_msgID != 0x7e8)
  {
    canMsgInfo[RX_MSG_ENTRY_START + 2].MessageId = RxTrig_XCP_CMD_CAN1_msgID;
  }

  {
    memset((void *)&rxBuf_286__0002[0][0], 0, sizeof(rxBuf_286__0002));
    memset((void *)&rxLen_286__0002[0], 0, sizeof(rxLen_286__0002));
    rxAge_286__0002 = MAX_AGE;
  }
...
void rxFn_286__0002(void * data)
{
  ...
  if ((msg->parameter1 == 8U) ) {
    for (i = 0; i < 8; i++) {
      if (i < msg->parameter1)
        rxBuf_286__0002[rxQHead_286__0002][i] = b[i];
      else
        rxBuf_286__0002[rxQHead_286__0002][i] = 0;
    }

    rxLen_286__0002[rxQHead_286__0002] = msg->parameter1;
    rxID_286__0002[rxQHead_286__0002] = msg->message_id;
    if ((rxQHead_286__0002 == rxQTail_286__0002) && (rxAge_286__0002 == 0))
      rxQTail_286__0002 = (rxQTail_286__0002 + 1) % 1U;
    if ((rxQHead_286__0002 == (rxQTail_286__0002 + 1)% 1U) && (rxAge_286__0002
         != 0))
      rxQTail_286__0002 = (rxQTail_286__0002 + 1) % 1U;
    rxQHead_286__0002 = (rxQHead_286__0002 + 1 ) % 1U;
    rxAge_286__0002 = 0;
  }
}

uint8_T can_get_286__0002(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  ...
  if (age != NULL)
    *age = rxAge_286__0002;
  if (id != NULL)
    *id = rxID_286__0002[rxQTail_286__0002];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (length > rxLen_286__0002[rxQTail_286__0002])
      length = rxLen_286__0002[rxQTail_286__0002];
    for (i = 0; i < 8; i++)
      data[i] = rxBuf_286__0002[rxQTail_286__0002][i];
  }

  if ((rxQHead_286__0002 != (rxQTail_286__0002 + 1)% 1U) && (rxAge_286__0002 ==
       0))
    rxQTail_286__0002 = (rxQTail_286__0002 + 1) % 1U;
  else if (rxAge_286__0002 < MAX_AGE)
    rxAge_286__0002++;
  return length;
}
...
/**** txMsgNum: 0 										 ****/
/**** i: 0 										 				 ****/
void can_send_744__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
...
uint32_T can_set_period_744__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
/**** txMsgNum: 1 										 ****/
/**** i: 1 										 				 ****/
void can_send_747__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!can_CAN1_startupDelay) {
    can_update_CAN1(id, extended, (length > 8U) ? 8U : length, data);
...
uint32_T can_set_period_747__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
/**** txMsgNum: 2 										 ****/
/**** i: 2 										 				 ****/
void can_send_38__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!can_CAN1_startupDelay) {
    can_update_CAN1(id, extended, (length > 8U) ? 8U : length, data);
...
uint32_T can_set_period_38__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  txPeriod_38__0002 = period;
  return period;
}

void can_send_periodic_38__0002(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data)
{
  static uint32_T last_ticks = 0;
  uint32_T current_ticks = ticks();
  if (txPeriod_38__0002 > 0) {
    if ((txLastTx_38__0002 + txPeriod_38__0002) <= current_ticks) {
      can_send_38__0002(id, extended, length, data);
      txLastTx_38__0002 = current_ticks;
      last_ticks = current_ticks;
    } else if (current_ticks < last_ticks) {
      if ((txLastTx_38__0002 + txPeriod_38__0002) > txPeriod_38__0002) {
        // handle overflows
        txLastTx_38__0002 = 0;
      }
    }
...
void can_process_CAN1(void)
{
  ...
  /* Receive for canMsgInfo 0xA5 - Mask: 0x7FF */

...
echo ### Beginning Build for Accelerator_019 ...
...
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\ECU\RPG\Training\Accelerator\Accelerator_raptor_rtw\Accelerator_019.hex" /Y
